...
蛭形轮虫（*Rotifera: Bdelloidea*）是微小的淡水无脊椎动物，在数千万年尺度上几乎不进行有性繁殖。（它到底有多「纯粹无性」近年受到分子证据的挑战——有研究找到了不支持完全禁欲的信号——所以存疑的是纯度，不是时间尺度。）按照传统进化理论，即使只是以无性为主的谱系也该陷入困境：无性繁殖导致 Muller 棘轮效应（有害突变不可逆积累）和对共同进化寄生虫的脆弱性（红皇后假说）。
...
结果是数千万年尺度上的韧性、多样性与适应——没有中央规划，也没有看门人。无论「它到底有多少有性繁殖」最终如何定论，它借用外源基因的规模是没有争议的，而本协议借鉴的正是这个机制。
